...
export class Ui {
  ...
  renderBoard() {
    ...
    render(this.controller.botPlayer.gameBoard.board, true, botBoard);
    ...
    function render(board, hideShips, container) {
      ...
      keyLegend.textContent = "x/y";
      keyLegend.classList.add("legend");
      keyLegend.classList.add("keyLegend");
  ...
  getInput() {
    ...
    placeShip.addEventListener("click", () => {
      ...
      document
        .querySelectorAll('input[name="axis"]')
    ...
    submit.addEventListener("click", (e) => {
      ...
      let axisValue = document.querySelector(
        'input[name="axis"]:checked',
      )?.value;
